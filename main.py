...
def continua_1(joc):
    while True:
        ...
        continua_inapoi = Button(image=None, pos=(150, resolutiaEcranului.current_h - 900), text_input="MENIU", font=font(50), base_color="black", hovering_color="white")
...
def pierdut(joc):
    ...
    while True:
        ...
        pierdut_inainte = Button(image=None, pos=(825, 600), text_input="CONTINUA",
                                 font=font(30), base_color="black", hovering_color="white")
        pierdut_inapoi = Button(image=None, pos=(1050, 600), text_input="MENIU", font=font(30), base_color="black",
                                hovering_color="white")
...
def castigat(joc):
    ...
    while True:
        ...
        castigat_inainte = Button(image=None, pos=(825, 600), text_input="CONTINUA",
                                 font=font(30), base_color="black", hovering_color="white")
        castigat_inapoi = Button(image=None, pos=(1050, 600), text_input="MENIU", font=font(30), base_color="black",
                                hovering_color="white")
