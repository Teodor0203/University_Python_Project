...
'animale' :['arici','aligator','acvila','barza','balena','bibilica','bizon','bursuc','camila','crocodil','cal','delfin','dihor','elefant','echidna','fazan','ghepard',
            'iepure','jder','jaguar','lebada','leopard','maimuta','nurca','castor','veverita','zebra','impala','tigru','leu','antilopa','caprioara','pisica','pantera','cangur','vulpe'],
'mașini' : ['volvo', 'mercedes', 'renault', 'subaru', 'volkswagen', 'hyundai', 'maserati', 'ferrari', 'porsche', 'tesla', 'bugatti', 'dodge', 'mustang'],

'țări' : ['spania', 'romania', 'germania', 'finlanda', 'brazilia', 'cehoslovacia', 'belarus', 'norvegia', 'thailanda', 'malaesya', 'uzbekistan', 'qatar', 'vatican']
